...
module Api.Request.Plausibility exposing
...
plausibilityCheckApi : Maybe String -> Maybe String -> String -> Api.Request Api.Data.PlausibilityReport
plausibilityCheckApi dateFrom_query dateTo_query auth_token =
    Api.request
        "GET"
        "/api/v1/bookkeeping/plausibility"
        []
        [ ( "date_from", Maybe.map identity dateFrom_query ), ( "date_to", Maybe.map identity dateTo_query ) ]
        []
        Nothing
        Api.Data.plausibilityReportDecoder
