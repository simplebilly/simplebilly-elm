...
module Api.Request.Onlineshop exposing
    ( getSmtpConfigApi
    , saveSmtpConfigApi
    )
...
getSmtpConfigApi : String -> Api.Request Api.Data.SmtpConfig
getSmtpConfigApi auth_token =
    Api.request
        "GET"
        ...
        []
        Nothing
        Api.Data.smtpConfigDecoder
        |> Api.withBearerToken auth_token

saveSmtpConfigApi : Maybe Api.Data.SmtpConfig -> String -> Api.Request Api.Data.SmtpConfig
saveSmtpConfigApi smtpConfig_body auth_token =
    Api.request
        "PUT"
        "/api/v1/settings/smtp"
        []
        []
        []
        (Maybe.map Http.jsonBody (Maybe.map Api.Data.encodeSmtpConfig smtpConfig_body))
        Api.Data.smtpConfigDecoder
        |> Api.withBearerToken auth_token
