...
module Api.Request.Suitability exposing
...
shippingSuitabilityApi : Api.Data.SuitabilityRequest -> String -> Api.Request Api.Data.SuitabilityResult
shippingSuitabilityApi suitabilityRequest_body auth_token =
    Api.request
        "POST"
        ...
        []
        []
        (Maybe.map Http.jsonBody (Just (Api.Data.encodeSuitabilityRequest suitabilityRequest_body)))
        Api.Data.suitabilityResultDecoder
