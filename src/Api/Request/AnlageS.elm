...
module Api.Request.AnlageS exposing
    ( anlageSApi
    )
...
anlageSApi : Int -> String -> Api.Request Api.Data.AnlageSErgebnis
anlageSApi year_query auth_token =
    Api.request
        "GET"
        ...
        []
        Nothing
        Api.Data.anlageSErgebnisDecoder
