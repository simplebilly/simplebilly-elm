...
module Api.Request.Gewinnverwendung exposing
    ( gewinnverwendungApi
...
gewinnverwendungApi : Int -> String -> Api.Request Api.Data.GewinnverwendungsReport
gewinnverwendungApi year_query auth_token =
    Api.request
        "GET"
        ...
        []
        Nothing
        Api.Data.gewinnverwendungsReportDecoder
        |> Api.withBearerToken auth_token

gewinnverwendungExportApi : Int -> String -> Api.Request Api.Data.GewinnverwendungsExportResponse
gewinnverwendungExportApi year_query auth_token =
    Api.request
        "GET"
        ...
        []
        Nothing
        Api.Data.gewinnverwendungsExportResponseDecoder
        |> Api.withBearerToken auth_token
