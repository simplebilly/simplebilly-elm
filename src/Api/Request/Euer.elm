...
module Api.Request.Euer exposing
    ( euerApi
    , euerKategorienApi
    )
...
euerApi : Int -> String -> Api.Request Api.Data.EuerErgebnis
euerApi year_query auth_token =
    Api.request
        "GET"
        ...
        []
        Nothing
        Api.Data.euerErgebnisDecoder
        |> Api.withBearerToken auth_token

euerKategorienApi : Int -> String -> Api.Request Api.Data.EuerDetailErgebnis
euerKategorienApi year_query auth_token =
    Api.request
        "GET"
        ...
        []
        Nothing
        Api.Data.euerDetailErgebnisDecoder
        |> Api.withBearerToken auth_token
