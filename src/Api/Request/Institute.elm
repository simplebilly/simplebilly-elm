...
module Api.Request.Institute exposing
    ( instituteStatusApi
    )
...
instituteStatusApi : String -> Api.Request Api.Data.InstituteStatus
instituteStatusApi auth_token =
    Api.request
        "GET"
        ...
        []
        Nothing
        Api.Data.instituteStatusDecoder
