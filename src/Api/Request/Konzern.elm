...
module Api.Request.Konzern exposing
    ( konzernExportApi
    , konzernStatusApi
    )
...
konzernExportApi : Int -> String -> Api.Request Api.Data.KonzernExportResponse
konzernExportApi year_query auth_token =
    Api.request
        "GET"
        ...
        []
        Nothing
        Api.Data.konzernExportResponseDecoder
        |> Api.withBearerToken auth_token

konzernStatusApi : Int -> String -> Api.Request Api.Data.KonzernStatus
konzernStatusApi year_query auth_token =
    Api.request
        "GET"
