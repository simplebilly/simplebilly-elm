...
module Api.Request.Offenlegung exposing
    ( offenlegungApi
    )
...
offenlegungApi : String -> Api.Request Api.Data.OffenlegungReport
offenlegungApi auth_token =
    Api.request
        "GET"
        ...
        []
        Nothing
        Api.Data.offenlegungReportDecoder
