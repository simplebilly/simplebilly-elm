...
module Api.Request.Stille exposing
    ( stilleExportApi
    , stilleReportApi
    )
...
stilleExportApi : Int -> String -> Api.Request Api.Data.StilleExportResponse
stilleExportApi year_query auth_token =
    Api.request
        "GET"
        ...
        []
        Nothing
        Api.Data.stilleExportResponseDecoder
        |> Api.withBearerToken auth_token

stilleReportApi : Int -> String -> Api.Request Api.Data.StilleReport
stilleReportApi year_query auth_token =
    Api.request
        "GET"
