...
module Api.Request.PaymentCondition exposing
...
listPaymentConditionsApi : String -> Api.Request (List Api.Data.PaymentCondition)
listPaymentConditionsApi auth_token =
    Api.request
        "GET"
        ...
        []
        Nothing
        (Json.Decode.list Api.Data.paymentConditionDecoder)
